<div class="col-md-3 col-sm-6"> 
        ...
        <input type="hidden" name="search" value="{{Request::get('search', '')}}"/> 
           ...
           <h4 class="widget-title">{{__('Refine Search')}}</h4>   
          <hr>    
          ...
          <div class="widget">
			...
			@endphp
                ...
                {{$jobTitle}} <span class="badge pull-right">{{App\Job::countNumJobs('title', $jobTitle)}}</span> </li>
          ...
          <div class="widget">
			...
			@endphp
              <li>
                ...
                {{$state->state}} <span class="badge pull-right">{{App\Job::countNumJobs('state_id', $state->state_id)}}</span> </li>
              @endif
          @endforeach
          @endif
              </ul>
          ...
          <div class="widget">
			...
			@endphp
              <li>
                ...
                {{$jobExperience->job_experience}} <span class="badge pull-right">{{App\Job::countNumJobs('job_experience_id', $jobExperience->job_experience_id)}}</span> </li>
              @endif
          @endforeach
          @endif
              </ul>
          ...
          <div class="widget">
			...
			@endphp
              <li>
                ...
                {{$jobType->job_type}} <span class="badge pull-right">{{App\Job::countNumJobs('job_type_id', $jobType->job_type_id)}}</span> </li>
              @endif
          @endforeach
          @endif
              </ul>
          ...
          <div class="widget">
			...
			@endphp
              <li>
                ...
                {{$jobShift->job_shift}} <span class="badge pull-right">{{App\Job::countNumJobs('job_shift_id', $jobShift->job_shift_id)}}</span> </li>
              @endif
          @endforeach
          @endif
              </ul>
          ...
          <div class="widget">
            ...
            <li>
                ...
                {{$careerLevel->career_level}} <span class="badge pull-right">{{App\Job::countNumJobs('career_level_id', $careerLevel->career_level_id)}}</span> </li>
              @endif
          @endforeach
          @endif
              </ul>
          ...
          <div class="widget">
			...
			@endphp
              <li>
                ...
                {{$degreeLevel->degree_level}} <span class="badge pull-right">{{App\Job::countNumJobs('degree_level_id', $degreeLevel->degree_level_id)}}</span> </li>
              @endif
          @endforeach
          @endif
              </ul>
          ...
          <div class="widget">
			...
			@endphp
              <li>
                ...
                {{$industry->industry}} <span class="badge pull-right">{{App\Job::countNumJobs('industry_id', $industry->id)}}</span> </li>
              @endif
          @endforeach
          @endif
              </ul>
          ...
          <div class="widget">
			...
			@endphp
              <li>
                ...
                {{$jobSkill->job_skill}} <span class="badge pull-right">{{App\Job::countNumJobs('job_skill_id', $jobSkill->job_skill_id)}}</span> </li>
              @endif
          @endforeach
          @endif
              </ul>
          ...
          <div class="widget">
			...
			@endphp
              <li>
                ...
                {{$functionalArea->functional_area}} <span class="badge pull-right">{{App\Job::countNumJobs('functional_area_id', $functionalArea->functional_area_id)}}</span>
              </li>                
          @endif
          @endforeach
          @endif
          ...
          <div class="widget">
			...
			@endphp
              <li>
                ...
                {{$company->name}} <span class="badge pull-right">{{App\Job::countNumJobs('company_id', $company->id)}}</span> </li>
              @endif
          @endforeach
          @endif
              </ul>
