...
class JobController extends Controller
{
    ...
    public function __construct()
    {
		...
		$this->defaultSortingItems = DataArrayHelper::defaultSortingItems();
    }
    ...
    public function jobsBySearch(Request $request)
    {
		...
		$country_ids = $siteSetting->default_country_id;
	...
	// echo $country_ids. " aasdas";
        ...
        return view('job.list')
						...
						->with('defaultSortingItems', $this->defaultSortingItems)
