...
Route::prefix('employer')->group(function () {
    Route::get('login', 'Company\Auth\LoginController@showLoginForm')->name('employer.login');
    Route::get('register', 'Company\Auth\RegisterController@showRegistrationForm')->name('employer.register');
});